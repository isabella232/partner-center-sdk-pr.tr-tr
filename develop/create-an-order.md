...
Şu anda satmaya sunulan bilgiler hakkında daha fazla bilgi için bkz. [bulut çözümü sağlayıcısı programındaki Iş ortağı teklifleri](/partner-center/csp-offers).
...
**Örnek**: [konsol test uygulaması](console-test-app.md). **Proje**: Iş Ortağı Merkezi SDK örnekleri **sınıfı**: CreateOrder.cs
