...
ms.locfileid: "115997218"
---
# <a name="reject-a-transfer"></a>Bir aktarımı reddetme
...
| Yöntem   | İstek URI'si                                                                                                 |
|----------|-------------------------------------------------------------------------------------------------------------|
| **DÜZELTMESI** | [*{BaseUrl}*](partner-center-rest-urls.md)/v1/Customers/{Customer-id}/Transfers/{transfer-ID} http/1.1                    |

### <a name="uri-parameter"></a>URI parametresi

Müşteriyi tanımlamak ve kabul edilecek aktarımı belirtmek için aşağıdaki yol parametresini kullanın.
...
| durum                | dize        | No    | TransferEntity durumu. Bir aktarımı reddetmek için, değer "Reddet" olarak ayarlanır|
...
Başarılı olursa, bu yöntem yanıt gövdesinde doldurulmuş [Transferentity](transfer-entity-resources.md) kaynağını döndürür.
