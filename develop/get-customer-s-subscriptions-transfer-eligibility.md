...
ms.locfileid: "115993461"
---
# <a name="get-a-customers-subscriptions-transfer-eligibility"></a>Müşterinin abonelik aktarım uygunluğunu alma

Aktarım için uygun/uygun olmayan bir müşterinin aboneliklerinin bir koleksiyonunu alma.
...
| Yöntem  | İstek URI'si                                                                                          |
|---------|------------------------------------------------------------------------------------------------------|
| **Al** | [*{BaseUrl}*](partner-center-rest-urls.md)/v1/Customers/{Customer-Tenant-id}/transferseligibility? transfertype = {aktarım-türü} http/1.1 |
...
| Aktarım türü      | string | Yes      | Hedeflenen aktarım türü.                |
...
Başarılı olursa, bu yöntem yanıt gövdesinde bir [Transferuygunluk](transfer-eligibility-resources.md) kaynakları koleksiyonu döndürür.
